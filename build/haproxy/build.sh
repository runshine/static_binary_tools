...
VERSION="3.3.0"
PACKAGE="haproxy"
apt-get -y install curl ca-certificates wget xz-utils libssl-dev libncurses-dev autoconf git libwrap0-dev libreadline-dev flex bison  liblua5.3-dev libpcre2-dev
...
sed -i 's/CC = cc/CC = cc -static /g' Makefile
make -j 8 TARGET=linux-glibc CFLAGS=-static USE_OPENSSL=1 USE_QUIC=1 USE_QUIC_OPENSSL_COMPAT=1 USE_LUA=1 USE_PCRE2=1
