...
PACKAGE="nmap"
EXT="tar.bz2"
apt-get -y install curl ca-certificates wget xz-utils libssl-dev libncurses-dev autoconf git libwrap0-dev libreadline-dev flex bison  liblua5.3-dev liblua5.4-dev libpcre2-dev libz-dev libzstd-dev bzip2 libpcap-dev libssh2-dev libdnet-dev liblinear-dev libnbase-dev libnsock-dev
